...
- [PAI-Bench](https://github.com/SHI-Labs/physical-ai-bench) - The main reference repository for this evaluation framework and code provided here.
- [VBench](https://github.com/Vchitect/VBench) - The repository used by PAI-Bench for VLM evaluation
